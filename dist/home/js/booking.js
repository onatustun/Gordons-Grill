...
const renderCalendar = (date) => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
        ...
        dayCell.on("click", () => {
            if (activeDate) {
                const previousActiveDayCell = dayGrid.find(`div[data-day='${activeDate.date()}']`)
...
$("#book-submit").on("click", (e) => {
    ...
    if ($("#start-time")[0].checkValidity() &&
        ...
        alert("We have received your booking and you will get an email about the details.")
    } else {
